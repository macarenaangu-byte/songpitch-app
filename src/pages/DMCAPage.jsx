...
export function DMCAPage({ onBack }) {
  ...
  return (
    <LegalPageLayout title="DMCA & Copyright Policy" onBack={onBack}>
      <p>Coda-Vault respects the intellectual property rights of others and expects its users to do the same. In accordance with the Digital Millennium Copyright Act (DMCA), we will respond promptly to claims of copyright infringement committed using our platform.</p>

      <h2 style={h2Style}>1. Copyright Infringement Claims</h2>
      <p>If you believe that content hosted on Coda-Vault infringes your copyright, please submit a written notice containing the following information:</p>
      <ul style={{ paddingLeft: 24, marginTop: 12 }}>
        <li>A physical or electronic signature of the copyright owner or authorized agent.</li>
        <li>Identification of the copyrighted work claimed to have been infringed.</li>
        <li>Identification of the material on Coda-Vault that is claimed to be infringing, with enough detail to locate it.</li>
      ...
      <p>Upon receipt of a valid DMCA notice, Coda-Vault will:</p>
      <ul style={{ paddingLeft: 24, marginTop: 12 }}>
      ...
      <p>Coda-Vault will terminate accounts of users who are determined to be repeat infringers. We maintain a policy of terminating access for users who repeatedly upload copyrighted content without authorization.</p>

      <h3 style={h3Style}>Rights Verification</h3>
      <p>Coda-Vault provides tools for composers to verify and document their rights ownership through our split sheet system. We encourage all users to maintain proper documentation of their music rights.</p>
